...
public class Difficulty{
  private File jarDir = new File(System.getProperty("user.dir")); //Directory of the java jar file
  private File diffDat= new File(jarDir, "difficulty.txt");
  ...
  public void writeDifficulty(int diffToWrite){
    try {
      ...
      FileWriter myWriter = new FileWriter(diffDat);
      myWriter.write(cur);
      myWriter.close();
