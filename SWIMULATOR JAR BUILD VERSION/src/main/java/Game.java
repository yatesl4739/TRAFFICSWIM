...
public class Game extends Canvas implements KeyListener, Runnable,MouseListener {
  ...
  public Game() {
    ...
    background1 = new Background("/background.png", 0, 1300);
    background2 = new Background("/background.png", 0, 2900);

    try {
      URL url = getClass().getResource("/Blurry.png");
    ...
    try {
      ...
      pricedown = Font.createFont(
              Font.TRUETYPE_FONT,
              getClass().getResourceAsStream("/pricedown.otf")
      ).deriveFont(50f);
